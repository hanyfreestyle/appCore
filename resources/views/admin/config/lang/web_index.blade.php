    ...
    <x-admin.hmtl.section>
        <div class="content mb-3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-9">
                        <x-admin.form.select-arr   :send-arr="config('adminLangFile.webFile')" name="selectfile" :sendvalue="$selId" label="{{__('admin/config/core.lang_select_file')}}" :labelview="false" />
                    </div>
                    <div class="col-3 dir_button">
                        <x-admin.form.action-button url="{{route('weblang.edit')}}"  print-lable="{{__('admin/config/core.lang_add_new_key')}}" size="m" :tip="false" bg="dark" />
                    </div>
                </div>
            </div>
        </div>
