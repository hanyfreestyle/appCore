                ...
                <div class="card-body table-responsive p-0">
                    <table  {!!Table_Style($viewDataTable,$yajraTable) !!}>
                        ...
                        <tr>
                            ...
                            <th>{{__('admin/def.form_'.$rolePrintName)}}</th>
                            ...
                            <tr>
                                ...
                                @can('roles_update_permissions')
                                    <td class="text-center">
                                        <x-admin.form.action-button url="{{route('users.roles.editRoleToPermission',$role->id)}}"   icon="fas fa-user-shield" print-lable="{{__('admin/config/roles.role_edit_permission')}}" bg="p" :tip="false"  />
                                    </td >
                                @endcan
