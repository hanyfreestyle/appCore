        ...
        <x-admin.card.def :pageData="$pageData" >
            <form  class="mainForm" action="{{route('users.permissions.update',intval($permission->id))}}" method="post"  enctype="multipart/form-data">
                ...
                <div class="col-lg-12">
                    ...
                    @endif
                    <div class="row">
                        <x-admin.form.input label="{{__('admin/def.form_name_ar')}}" name="name_ar" :requiredSpan="true" colrow="col-lg-4"
                                            value="{{old('name_ar',$permission->name_ar)}}" inputclass="dir_ar"/>

                        <x-admin.form.input label="{{__('admin/def.form_name_en')}}" name="name_en" :requiredSpan="true" colrow="col-lg-4"
