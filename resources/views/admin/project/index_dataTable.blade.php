        ...
        $(function () {
            var table = $('.DataTableView').DataTable({
                ...
                columns: [
                    ...
                    {data: 'ProjectUnits', name: 'ProjectUnits', orderable: false, searchable: false},
                    {data: 'ProjectPhoto', name: 'ProjectPhoto', orderable: false, searchable: false},
                    {data: 'ProjectFaq', name: 'ProjectFaq', orderable: false, searchable: false},
                        @endcan
